    ...
    <div class="contener">
        ...
        <div class="search">
           <form method="get"  action="/search" id="search">
                ...
                <input class="search_input" type="text" name="search" wire:model="search" placeholder="Search Event,Category,location ..."/><!--
                --><div class="selec_box">
...
<article id="categories" class="section_gap">
    <div class="contener">
        ...
        <div class="categories_box">
            ...
            <a class="category_item" href="{{ route('category',['categoryId'=>$category->id]) }}" title="{{ $category->name}}">
